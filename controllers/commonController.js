...
// const newsLetterDB = require('../medisure-mongoose-model/models/newsLetter');
// const userQueriesDB = require('../medisure-mongoose-model/models/userQueries');
const mailService = require('../utils/mailService/mail');
// const emailTemplateDB = require('../medisure-mongoose-model/models/emailTemplates');
